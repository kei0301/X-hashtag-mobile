...
import { BondingContract, UniversalMockERC20Token } from "../../abi";
...
export abstract class Bond {
    ...
    public getNewContractForBond(networkID: Networks, provider: StaticJsonRpcProvider | JsonRpcSigner) {
        const bondAddress = this.getAddressForBond(networkID);
        return new Contract(bondAddress, BondingContract, provider);
    }
