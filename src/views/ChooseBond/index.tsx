            ...
            <Zoom in={true}>
                <div className="choose-bond-view-card">
                    {/* <div className="choose-bond-view-card-header">
                        <p className="choose-bond-view-card-title"> Mint (DAO, DAO)</p>
                    </div> */}

                    <Grid container item xs={12} spacing={2} className="choose-bond-view-card-metrics">
                        <Grid item xs={12} sm={12}>
                            <Box textAlign="center">
                                <p className="choose-bond-view-card-metrics-title"> Total Liquidity Bonded </p>
                        ...
                        {/* <Grid item xs={12} sm={6}>
                            <Box textAlign="center">
                                <p className="choose-bond-view-card-metrics-title">XIGMA Price</p>
                                <p className="choose-bond-view-card-metrics-value">{isAppLoading ? <Skeleton width="100px" /> : `$${trim(marketPrice, 3)}`}</p>
                            </Box>
                        </Grid> */}
                    </Grid>
                                    ...
                                    <TableHead>
                                        <TableRow>
                                            ...
                                            <TableCell align="right">
                                                <p className="choose-bond-view-card-table-title">Total Bonded Value</p>
                                            </TableCell>
