...
function BondPurchase({ bond, slippage }: IBondPurchaseProps) {
    console.log(
        "bond inside bondpurchase", bond.bondQuote, bond.balance, bond.allowance
    )
    ...
    useEffect(() => {
        dispatch(calcBondDetails({ address, bond, value: quantity, provider, networkID: chainID }));
    }, [bondDetailsDebounce]);
    ...
    const handleZapinOpen = () => {
        dispatch(calcBondDetails({ address, bond, value: "0", provider, networkID: chainID }));
        setZapinOpen(true);
    };
            ...
            <Slide direction="left" in={true} mountOnEnter unmountOnExit {...{ timeout: 533 }}>
                <Box className="bond-data">
                    ...
                    <div className="data-row">
                        ...
                        <p className="price-data bond-balance-title">{isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.bondQuote, 4)} TestToken`}</p>
                    </div>

                    {/* <div className={`data-row`}>
                        <p className="bond-balance-title">Max You Can Buy</p>
                        <p className="price-data bond-balance-title">{isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.maxBondPrice, 4)} XIGMA`}</p>
                    </div> */}
                    ...
                    {/* <div className="data-row">
                        ...
                        <p className="bond-balance-title">0.01 XIGMA</p>
                    </div> */}
                </Box>
            </Slide>
