...
function Zapin({ open, handleClose, bond }: IZapinProps) {
    ...
    let defaultToken = tokens.find(token => token.name === mim.name);
    ...
    useEffect(() => {
        // setTimeout(async () => {
        //     let { amount } = await calcZapinDetails({ token, provider, networkID: chainID, bond, value: "1", slippage, dispatch });
        //     amount = "11";
        //     if (amount) {
                    ...
                    <div className="zapin-body">
                        ...
                        <div className="zapin-body-params">
                            ...
                            <div className="data-row">
                                ...
                                <p className="data-row-value">{isLoading ? <Skeleton width="100px" /> : `~ ${trim(bond.bondQuote, 4)} XIGMA`}</p>
                            </div>
                            <div className="data-row">
                                <p className="data-row-name">Max You Can Buy</p>
                                <p className="data-row-value">{isLoading ? <Skeleton width="100px" /> : `${trim(bond.maxBondPrice, 4)} XIGMA`}</p>
                            </div>
                            <div className="data-row">
                            ...
                            {/* <div className="data-row">
                                ...
                                <p className="data-row-value">0.01 XIGMA</p>
                            </div> */}
                        </div>
                    </div>
