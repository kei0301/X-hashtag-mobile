                            ...
                            <Box direction="row" className="bond-price-data-row">
                                <div className="bond-price-data">
                                    ...
                                    <p className="bond-price-data-value">
                                        {isBondLoading ? <Skeleton /> : bond.isLP || bond.name === "wavax" ? `$${trim(bond.bondPrice, 3)}` : `${trim(bond.bondPrice, 2)} ${bond.name}`}
                                    </p>
                                </div>
                                <div className="bond-price-data">
                                    <p className="bond-price-data-title">TestToken Price</p>
                                    <p className="bond-price-data-value">{isBondLoading ? <Skeleton /> : `$${trim(bond.marketPrice, 3)}`}</p>
                                </div>
                            </Box>
