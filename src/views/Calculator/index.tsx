                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={4} md={4} lg={4}>
                                        <div className="calculator-card-apy">
                                            <p className="calculator-card-metrics-title">TestToken Price</p>
                                    ...
                                    <Grid item xs={6} sm={4} md={4} lg={4}>
                                        <div className="calculator-card-index">
                                            <p className="calculator-card-metrics-title">Your sXIGMA Balance</p>
                                            <p className="calculator-card-metrics-value">{isAppLoading ? <Skeleton width="100px" /> : <>{trimmedMemoBalance} sXIGMA</>}</p>
                                        </div>
                                    </Grid>
                                </Grid>
                            </div>
                        ...
                        <div className="calculator-card-area">
                            <div>
                                    ...
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} sm={6}>
                                            <div className="calculator-card-action-area-inp-wrap">
                                                <p className="calculator-card-action-area-inp-wrap-title">sXIGMA Amount</p>
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <div className="calculator-card-action-area-inp-wrap">
                                                <p className="calculator-card-action-area-inp-wrap-title">XIGMA price at purchase ($)</p>
                                                <div className="vertical-border-wrapper">
                                                    <div className="top-border-div"></div>
                                                </div>
                                                <div className="left-border-div"></div>
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <div className="calculator-card-action-area-inp-wrap">
                                                <p className="calculator-card-action-area-inp-wrap-title">Future XIGMA market price ($)</p>
                                                <div className="vertical-border-wrapper">
                                                    <div className="top-border-div"></div>
                                                </div>
                                                <div className="left-border-div"></div>
                                ...
                                <div className="calculator-user-data">
                                    ...
                                    <div className="data-row">
                                        <p className="data-row-name">XIGMA rewards estimation</p>
                                        <p className="data-row-value">{isAppLoading ? <Skeleton width="80px" /> : <>{rewardsEstimation} XIGMA</>}</p>
                                    </div>
                                    <div className="data-row">
